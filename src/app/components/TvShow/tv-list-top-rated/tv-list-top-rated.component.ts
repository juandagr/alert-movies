...
@Component({
  selector: 'app-tv-list-top-rated',
  templateUrl: './tv-list-top-rated.component.html',
  styleUrls: ['./tv-list-top-rated.component.scss']
})
export class TvListTopRatedComponent implements OnInit {
  ...
  changePage(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/top_rated', this.currentPage]);
    this.getTvShowsActualPage();
  ...
  getTvShowsActualPage() {
    this.tvShowService.getTopRatedTv(this.currentPage).subscribe(
      (data: any ) => {
        this.tvShows = data;
  ...
  changeLinks(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/top_rated', this.page]);
    this.getTvShowsActualPage();
  }
