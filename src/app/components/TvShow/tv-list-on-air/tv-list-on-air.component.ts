...
@Component({
  selector: 'app-tv-list-on-air',
  templateUrl: './tv-list-on-air.component.html',
  styleUrls: ['./tv-list-on-air.component.scss']
})
export class TvListOnAirComponent implements OnInit {
  ...
  changePage(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/on_air', this.currentPage]);
    this.getTvShowsActualPage();
  ...
  getTvShowsActualPage() {
    this.tvShowService.getrTvShowOnAir(this.currentPage).subscribe(
      (data: any ) => {
        this.tvShows = data;
  ...
  changeLinks(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/on_air', this.page]);
    this.getTvShowsActualPage();
  }
