...
@Component({
  selector: 'app-tv-list-latest',
  templateUrl: './tv-list-latest.component.html',
  styleUrls: ['./tv-list-latest.component.scss']
})
export class TvListLatestComponent implements OnInit {
  ...
  changePage(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/latest', this.currentPage]);
    this.getTvShowsActualPage();
  ...
  getTvShowsActualPage() {
    this.tvShowService.getLatestTv(this.currentPage).subscribe(
      (data: any ) => {
        this.tvShows = data;
  ...
  changeLinks(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/tv/latest', this.page]);
    this.getTvShowsActualPage();
  }
