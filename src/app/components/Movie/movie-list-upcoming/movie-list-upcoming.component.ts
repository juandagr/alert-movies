...
export class MovieListUpcomingComponent implements OnInit {
  ...
  changePage(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/list-movies/upcoming', this.currentPage]);
    this.getMoviesActualPage();
  ...
  changeLinks(event: IPageChangeEvent): void {
    ...
    this.router.navigate(['/list-movies/upcoming', this.page]);
    this.getMoviesActualPage();
  }
